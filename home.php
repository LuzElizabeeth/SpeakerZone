...
<body>
    <div class="container-bg">
        <div class="main-card">
            ...
            <?php if (isset($_GET['msg'])) echo "<p class='success-msg'>".htmlspecialchars($_GET['msg'])."</p>"; ?>
                            ...
                            <td>
                                <?php if ($_SESSION["usuario_tipo"] == "asistente"): ?>
                                    <form method="POST" action="inscribirse.php" style="display:inline;">
                                        ...
                                        <button type="submit" class="action-btn">Inscribirse</button>
                                    </form>
                                <?php endif; ?>
                                <?php if ($_SESSION["usuario_tipo"] == "presentador" && $_SESSION["usuario_id"] == $row["presentador_id"]): ?>
                                    <a href="editar_conferencia.php?id=<?php echo $row["id"]; ?>" class="action-link">Editar</a>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endwhile; ?>
            ...
            <?php if ($_SESSION["usuario_tipo"] == "presentador"): ?>
                <form method="get" action="admin_conferencias.php" style="margin-top:20px;">
                    <button type="submit" class="main-btn">Crear nueva conferencia</button>
                </form>
            <?php endif; ?>
